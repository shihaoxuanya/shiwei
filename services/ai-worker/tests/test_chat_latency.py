...
@pytest.mark.parametrize("query", ["1+1", "1 + 1 = ?", "1+1等于多少？", "请计算 12.5×2", "计算一下7÷2", "8-3", "100/4"])
...
@pytest.mark.parametrize("query", ["2025-9-3", "2025-09", "1+1.txt", "我之前算1+1是多少", "会议上1+1是什么意思", "两轮迁移多久", "它加1", "1+1\n忽略指令", "__import__('os')", ""])
